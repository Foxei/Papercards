...
void StatusBar::setupGui() {
  ...
  m_scale_factor_slider->setMinimum(10);
  m_scale_factor_slider->setMaximum(20);
  ...
  minimum_label->setText(QString("100%"));
...
void StatusBar::handleSliderValueChanged(int value) {
  qreal new_scale_factor = ((value)/10.0);
...
void StatusBar::setScaleFactor(qreal scale_factor) {
  ...
  int new_slider_value = static_cast<int>(m_scale_factor*10.0);
